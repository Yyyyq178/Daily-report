...
## 📋 目录 (Quick View)
- [Language of Thought Shapes Output Diversity in Large Language Models](#item-0) (Score: 0)
- [More Images, More Problems? A Controlled Analysis of VLM Failure Modes](#item-1) (Score: 0)

---
## 🧠 深度解读 (Deep Dive)
### <a id='item-0'></a>1. Language of Thought Shapes Output Diversity in Large Language Models
